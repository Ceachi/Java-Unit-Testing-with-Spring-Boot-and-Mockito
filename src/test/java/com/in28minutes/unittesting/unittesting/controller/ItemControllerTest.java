...
public class ItemControllerTest {
	...
	@MockBean // asta este a lu Spring Boot
	...
	public void dummyItem_basic() throws Exception {
		...
		MvcResult result = mockMvc.perform(request)
				...
				.andExpect(content().json("{\"id\": 1,\"name\":\"Ball\",\"price\":10,\"quantity\":100}")) // copy paste ce a returnat, daca am da get normal
				// pot sterge quantity de aici daca vreau
				.andReturn();
		//JSONAssert.assertEquals(expected, result.getResponse().getContentAsString(), false);
		// ultima este strict parameter = 
